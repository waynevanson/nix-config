...
The worktree plugin prepares the worktree and records state before you start. If you are running without the plugin, compute the identifiers below and create the worktree manually with `git worktree add -b <feature-branch> <worktree-path>`.
